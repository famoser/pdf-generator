...
class DocumentStructureVisitor
{
    ...
    {
        $identifier = $this->identifierGenerator->generateIdentifier('F');
    ...
    /**
     * @param Structure2\Image $param
     *
     * @return Image
     */
    public function visitImage(Structure2\Image $param)
    {
        $identifier = $this->identifierGenerator->generateIdentifier('I');
